...
<div id="imageFlow">
    <div class="top">
        <div id="Content1" style="background-color: #181818;">
            ...
            <div style="color:#bc5a2b; text-align: center;"><a href="mainForm">Enter the Store</a></div>

            <div style="color:#fff; text-align: center;"><sub>Copyright CSU </sub></div>
        </div>
    </div>
    <div class="bank">
        <a rel="images/main-page.jpg" title="CATS" href="#">
            My identity lies in not knowing who I am</a>
        <a rel="images/main-page2.jpg" title="CATS" href="#">
            ...are made by not following instructions</a>
        <a rel="images/main-page3.jpg" title="CATS" href="#">
            ...can come between us</a>
        <a rel="images/main-page4.jpg" title="CATS" href="#">
            Here you come!</a>
        <a rel="images/main-page5.jpg" title="CATS" href="#">
